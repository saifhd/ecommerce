...
?>
	<div class="home">
		...
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			...
			<h2 class="home_title">All Products Filtered By Price</h2>
		</div>
	</div>
				...
				<div class="col-lg-3">
					...
					<div class="shop_sidebar">
						...
						<div class="sidebar_section filter_by_section">
							...
							<div class="sidebar_subtitle"><a href="{{route('product.filter.price')}}" class="list-group"> Price</a></div>
								...
								<ul>
									<li>
										...
										<ul>
											...
											<a href="{{route('product.filter.price')}}">price</a> </li>
										</ul>
									</li>
								</ul>
							</div>
