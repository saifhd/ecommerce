...
<div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Blog Category List <a href="" class="btn btn-sm btn-warning" style="float : right;" 
            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="{{route('edit.blog.category',$category->id)}}" class="btn btn-sm btn-info">Edit</a>
                  <a href="{{route('delete.blog.category',$category->id)}}" class="btn btn-sm btn-danger" id="delete">Delete</a>
