...
<div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Coupon List <a href="" class="btn btn-sm btn-warning" style="float : right;" 
            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="{{route('edit.coupon',$coupon->id)}}" class="btn btn-sm btn-info">Edit</a>
