...
<div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Newsletter List <a href="" class="btn btn-sm btn-warning" style="float : right;" 
          data-toggle="modal" data-target="#modaldemo3">All Delete</a></h6>
          ...
          <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  <td><input class="form-group" type="checkbox"> {{$nw->id}}</td>
                  <td>{{$nw->email}}</td>
                  <td>{{\Carbon\Carbon::parse($nw->created_at)->diffForhumans()}}</td>
                  <td>
                  <a href="{{route('delete.newsletter',$nw->id)}}" class="btn btn-sm btn-danger" id="delete">Delete</a>
